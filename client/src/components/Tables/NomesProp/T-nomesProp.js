...
function TnomesProp() {
    ...
    const addToList = () => {
        Axios.post("http://localhost:3001/insert1", { word: word });
        window.location.reload();
    };

    const updateWord = (id) => {
        Axios.put("http://localhost:3001/update1", { id: id, newWord: newWord })
        window.location.reload();
    };
    ...
    return (
        <div className="App">
            ...
            <h1 className='title'>Nomes próprios</h1>
